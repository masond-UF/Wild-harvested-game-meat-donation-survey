...
donations.col <- c("Total_donations",
...
ggplot(processed_data, aes(x = fct_rev(Program_abbr), y = Donations)) +
  ...
  coord_flip() +
  theme_minimal() +
  labs(title = "Total Donations by Program",
...
funds.col <- c("Funding_total", "Funding_total_units", "Funding_public_donations",
